...
1.1	Teilaufgaben	1
1.2	Rahmenbedingung	1
1.3	Annahmen	1
2	Ausarbeitung in Python	2
2.1	Libraries	2
2.2	Datenbearbeitung	2
2.2.1	CSV einlesen und Pfad festlegen	3
2.2.2	Daten zu float Werten umwandeln	3
2.2.3	Werte nach “Älteste Zuerst” sortieren	3
2.2.4	Datum der Werte anpassen	3
2.2.5	Datum als Indexwert definieren	3
2.2.6	Bereinigen	4
2.3	Daten mit Pandas Plotten	4
2.4	Aufgabe a - Bestimmen Sie den Median der empirischen Renditeverteilung.	4
2.5	Aufgabe b - Bestimmen Sie das erste Quartil der Renditeverteilung	5
2.6	Aufgabe c - Das arithmetische Mittel der diskreten Renditen wird berechnet, falls die erwartete Rendite in zukünftigen Monaten (ex ante) zu schätzen ist. Bestimmen Sie dieses mit den verfügbaren Daten.	5
2.7	Aufgabe d - Das geometrische Mittel diskreter Renditen wird berechnet, falls die tatsächliche Performance (ex post) zu ermitteln ist. Bestimmen Sie dieses mittels Anfangs- und Endwert des SMI.	6
2.8	Aufgabe e - Schätzen Sie die Standardabweichung (Volatilität) der SMI-Monatsrenditen und simulieren Sie den weiteren Verlauf des SMI.	6
2.8.1	LSTM Model / SMI Simulation mit KI (Zusatz)	10
3	Fazit	14
...
Abbildung 1: Datenset nach der Datenverarbeitung	4
Abbildung 2 - BoxPlot mit Median in Rot	5
Abbildung 3 - BoxPlot mit Erstem Quartil in Rot	5
Abbildung 4 - Mögliche Entwicklung des SMIs im Monat April	7
Abbildung 5 - Optimale und Suboptimale Entwicklung des SMIs	7
Abbildung 6 - Erste Prediction des SMI verlaufs	9
Abbildung 7 - Sechs mögliche SMI Predictions	9
Abbildung 8 - Trainierte Vorhersage des LSTM Models	10
Abbildung 9 - Simulation des SMIs mittels unserem LSTM Model	13
